...
\begin{enumerate}
\item{Dissolve 10 table spoons of sugar in about 100 mL of water. This solution should be very concentrated and thick.}
...
\item{Which part of the vascular system of a plant functions like the capillary tube?}
\end{enumerate}
...
\item{Draw the cross section of the root, stem, and leaf you have just observed, showing the distribution of colour.}
\end{enumerate}
...
\subsubsection*{Activity Procedure}
\begin{enumerate}
\item{Fill the beaker with coloured water.}
...
\subsubsection*{Preparation Procedure}
\begin{enumerate}
\item{Cut plastic bottles to get six inch containers.}
...
\subsubsection*{Learning Objectives}
\begin{itemize}
\item{To measure human pulse rate.}
\end{itemize}
...
\subsubsection*{Notes}
When counting the pulse rate, there should be no distractions on the students.
